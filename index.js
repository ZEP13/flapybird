...
function renderGame() {
  ...
  if (score < best_score) {
    ...
    context.fillText(`New best: ${best_score}`, 5, 45);
  }
}
...
function renderGameOver() {
  if (gameOverImg.complete) {
    ...
    let bestScoreText = `Best score: ${best_score}`;
    context.fillStyle = "white";
    context.font = "45px sans-serif";
    ...
    // Affiche le meilleur score sous le score actuel
    context.fillText(bestScoreText, boardWidth / 2, y + imgHeight + 100);
